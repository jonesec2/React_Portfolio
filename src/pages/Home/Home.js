      ...
      <Card>
         <div className="w-100">
            ...
            <p className="lead mb-5">I am an experienced Quality Analyst ready to transition from validating applications to
                   creating them.</p>
               <p className="lead mb-5">This portfolio was created using a Bootstrap template created by <a href="https://startbootstrap.com/themes/resume/">Start Bootstrap</a>.</p>
